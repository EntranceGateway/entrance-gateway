...
export function SyllabusDetailSidebar({ info, detailUri }: SyllabusDetailSidebarProps) {
  return (
        ...
        <div className="divide-y divide-gray-100">
          ...
          <div className="px-4 sm:px-5 py-3 sm:py-4 group hover:bg-gray-50 transition-colors">
            ...
            <div className="flex items-center gap-2">
              ...
              <p data-role="subject-name" className="text-gray-900 text-sm font-medium">{info.subjectName}</p>
            </div>
          </div>
          ...
          <div className="px-4 sm:px-5 py-3 sm:py-4 group hover:bg-gray-50 transition-colors">
            ...
            <div className="flex items-center gap-2">
              ...
              <p data-role="credit-hours" className="text-gray-900 text-sm font-medium">{info.creditHours} Credit Hours</p>
            </div>
          </div>
          ...
          {info.lectureHours > 0 && (
            <div className="px-4 sm:px-5 py-3 sm:py-4 group hover:bg-gray-50 transition-colors">
              ...
              <div className="flex items-center gap-2">
                ...
                <p data-role="lecture-hours" className="text-gray-900 text-sm font-medium">{info.lectureHours} Hours</p>
              </div>
            </div>
          )}
          ...
          {info.practicalHours > 0 && (
            <div className="px-4 sm:px-5 py-3 sm:py-4 group hover:bg-gray-50 transition-colors">
              ...
              <div className="flex items-center gap-2">
                ...
                <p data-role="practical-hours" className="text-gray-900 text-sm font-medium">{info.practicalHours} Hours</p>
              </div>
            </div>
          )}

          {/* Program */}
          {/* SCRAPER: data-role="program" */}
          <div className="px-4 sm:px-5 py-3 sm:py-4 group hover:bg-gray-50 transition-colors">
          ...
          <div className="px-4 sm:px-5 py-3 sm:py-4 group hover:bg-gray-50 transition-colors">
            ...
            <div className="flex items-center gap-2">
              ...
              <p data-role="semester" className="text-gray-900 text-sm font-medium">{info.semester}</p>
            </div>
          </div>

          {/* Year */}
          {/* SCRAPER: data-role="year" */}
          <div className="px-4 sm:px-5 py-3 sm:py-4 group hover:bg-gray-50 transition-colors">
            ...
            <div className="flex items-center gap-2">
              ...
              <p data-role="year" className="text-gray-900 text-sm font-medium">Year {info.year}</p>
            </div>
          </div>
        </div>
      </div>
