...
import type { User, UpdateUserRequest, UserProfileFull } from '@/types/user.types'

interface ProfilePageContentNewProps {
  initialData: UserProfileFull
}

export function ProfilePageContentNew({ initialData }: ProfilePageContentNewProps) {
  const [activeTab, setActiveTab] = useState<ProfileSidebarTab>('history')
  ...
  return (
    <>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8">
        ...
        {/* Stats Cards */}
        <ProfileStats
          totalEnrollments={initialData.totalEnrollments}
          totalQuizAttempts={initialData.totalQuizAttempts}
          totalPurchases={initialData.totalPurchases}
          totalAdmissions={initialData.totalAdmissions}
        />
        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-x-8">
          ...
          <div className="space-y-6 sm:px-6 lg:px-0 lg:col-span-9">
            ...
            {activeTab === 'history' && <ProfileHistory initialData={initialData} />}
          </div>
        </div>
      </div>
